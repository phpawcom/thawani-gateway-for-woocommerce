...
final class PaymentMethodIntegration extends AbstractPaymentMethodType {
	...
	public function get_payment_method_script_handles() {
		...
		if ( function_exists( 'wp_set_script_translations' ) ) {
			wp_set_script_translations( $handle, 'thawani', WC_GATEWAY_THAWANI_PATH . 'languages' );
		}
	...
	public function get_payment_method_data() {
		return array(
			'title'       => $this->get_setting( 'title', __( 'Visa or MasterCard', 'thawani' ) ),
			'description' => $this->get_setting( 'description', __( 'Pay using Visa or MasterCard via Thawani Gateway', 'thawani' ) ),
